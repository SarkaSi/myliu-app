...
# Tik 4 ir 5 nuotraukos (indeksai 3 ir 4)
scenarios = [
    {
        "name": "darius_nature_walk",
        "index": 3,
        "prompt": f"realistic photograph, natural portrait of 32 year old male, man, {darius_data['body_type']} body type, {darius_data['height']}, {darius_data['hair_color']} hair, {darius_data['eye_color']}, bearded or stubbled face, masculine features, strong jaw, peaceful nature walk afternoon, forest path, upper body portrait, chest up framing, soft natural forest light, casual outdoor male outfit, comfortable walking clothes, natural male hairstyle, realistic male skin texture, subtle imperfections, calm peaceful masculine expression, real photo, authentic, documentary style, not AI art, high quality, detailed face, photorealistic"
    },
    {
        "name": "darius_coffee_cafe",
        "index": 4,
        "prompt": f"realistic photograph, natural portrait of 32 year old male, man, {darius_data['body_type']} body type, {darius_data['height']}, {darius_data['hair_color']} hair, {darius_data['eye_color']}, bearded or stubbled face, masculine features, strong jaw, cozy cafe morning, reading and coffee, upper body portrait, chest up framing, natural window light, casual comfortable male outfit, relaxed weekend clothes, natural male hairstyle, realistic male skin texture with pores, minor imperfections, relaxed thoughtful masculine expression, real photo, authentic, documentary style, not AI art, high quality, detailed face, photorealistic"
    }
]
    ...
    adetailer_args = [
        {
            ...
            "ad_prompt": "realistic face, natural skin texture with pores, detailed eyes, natural expression, subtle imperfections, masculine features",
            "ad_negative_prompt": "bad face, deformed face, blurry face, perfect skin, flawless, airbrushed, worst quality, low quality, woman, female, feminine",
            "ad_confidence": 0.3,
            "ad_mask_k_largest": 1,
...
def main():
    ...
    # Generuoti tik 4 ir 5 nuotraukas
    for i, scenario in enumerate(scenarios):
        seed = BASE_SEED + scenario['index'] * 150
        ...
        print(f"Generated {i+1}/2 images\n")
